...
func TestCalcCreditsBasic(t *testing.T) {
	...
	credits, micro, cost := calcCredits(price, 1_000_000, 500_000, 0, 0.01)
...
func TestCalcCreditsCacheReadFallsBackToInputPrice(t *testing.T) {
	...
	_, _, cost := calcCredits(price, 0, 0, 2_000_000, 0)
...
func TestCalcCreditsUsesDedicatedCachePrice(t *testing.T) {
	...
	_, _, cost := calcCredits(price, 0, 0, 1_000_000, 0)
...
func TestCalcCreditsNoPricing(t *testing.T) {
	credits, micro, cost := calcCredits(&modelPriceEntry{noPricing: true}, 100, 100, 0, 0.01)
...
func TestCalcCreditsZeroRateMeansNoCredits(t *testing.T) {
	...
	credits, micro, cost := calcCredits(price, 1_000_000, 0, 0, 0)
	if cost <= 0 {
