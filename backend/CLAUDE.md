...
Scoped out (see `docs/design/09-extensibility.md` ADR addendum): the generic hook dispatcher and event bus (`internal/biz/extension/`, `internal/biz/eventbus/` — separate P3 items, not requested), and multi-block tool-result redaction rewrite.
